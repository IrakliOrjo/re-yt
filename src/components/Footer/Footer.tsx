...
export const Footer = () => {
  return (
    <div className="flex flex-col bg-slate-900">
        <div className="flex flex-col lg:flex-row justify-between py-[50px] xl:px-20
        px-5">
       ...
       <AddressInfo />
       <div className="flex flex-col xl:flex-row gap-3 justify-between px-5 xl:px-20 mb-11">
