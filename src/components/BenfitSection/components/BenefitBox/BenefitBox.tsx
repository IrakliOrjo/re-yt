...
export const BenefitBox:FC <IBenefitBoxProps> = ( { img, title, description} ) => {
  return (
    <div className="flex items-center gap-9 bg-white rounded-2xl p-8 cursor-pointer 
    group hover:scale-105 hover:shadow-lg transition-transform duration-300">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-[14px] text-gray-500 xl:max-w-[386px]">{description}</p>
      </div>
    </div>
  )
}
